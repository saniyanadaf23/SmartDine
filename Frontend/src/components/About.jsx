      ...
      <section className="about" id="about">
        <div className="container">
          <div className="banner">
            ...
            <p className="mid">
            Welcome to Smart Dine, where innovation meets exceptional dining experiences.

At Smart Dine, we are committed to transforming the way people discover, reserve, and enjoy their favorite restaurants. 
...
Effortless Reservations - Book your table with ease, anytime, anywhere.
...
With Smart Dine, dining is no longer just a necessity—it's an experience.
 Join us in redefining modern dining and discover the smarter way to enjoy great food.
